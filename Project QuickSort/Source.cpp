/*
/   Uses a quickSort loop algorithem modified to work on multidimensional data
...
int main() {
    ...
    GasWell().quicksortFlowToTemp(sortedWells, 0, sortedWells.size() - 1);

    // Displays the sorted list
    cout << "Sorted Well Data Based on Flow Rate / Temperature Ratio:\n";
